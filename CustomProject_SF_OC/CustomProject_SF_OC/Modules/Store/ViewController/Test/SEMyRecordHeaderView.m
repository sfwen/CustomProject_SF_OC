...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        line.backgroundColor = HEXCOLOR(0x666666);
...
- (UILabel*)labelMyRecord {
    if (!_labelMyRecord) {
        ...
        _labelMyRecord.textColor = HEXCOLOR(0x666666);
    }
...
- (UIButton*)btnModifyRecord {
    if (!_btnModifyRecord) {
        ...
        [_btnModifyRecord setTitleColor:HEXCOLOR(0x666666) forState:UIControlStateNormal];
