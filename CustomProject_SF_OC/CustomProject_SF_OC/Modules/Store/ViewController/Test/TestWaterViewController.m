...
@interface TestWaterViewController ()
...
@implementation TestWaterViewController
...
- (void)registerCollectionViewCell {
    [self.collectionView registerClass:[SEMyRecordLabelCell class] forCellWithReuseIdentifier:[SEMyRecordLabelCell cellIdentifier]];
    [self.collectionView registerClass:[MultilineTextCell class] forCellWithReuseIdentifier:[MultilineTextCell cellIdentifier]];
    [self.collectionView registerClass:[SEMyRecordHeaderView class] forSupplementaryViewOfKind:UICollectionElementKindSectionHeader withReuseIdentifier:[SEMyRecordHeaderView headerViewIdentifier]];
}
...
- (CollectionViewLayoutType)collectionView:(UICollectionView *)collectionView layout:(SFCollectionViewFlowLayout *)collectionViewLayout typeOfLayout:(NSInteger)section {
    switch (section) {
        case 0:
            return CollectionViewLayoutType_LabelLayout;
        case 1:
        case 2:
            return CollectionViewLayoutType_FillLayout;
        case 3:
        case 4:
            return CollectionViewLayoutType_AbsoluteLayout;
        case 5:
        case 6:
            return CollectionViewLayoutType_PercentLayout;
        default:
            return CollectionViewLayoutType_ClosedLayout;
    }
}
    ...
    if (indexPath.section == 8) {
        ...
        switch (indexPath.section) {
            case 0: {
                ...
                cell.contentView.backgroundColor = HEXCOLOR(0xc4e9ff);;
